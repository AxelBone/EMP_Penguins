...
# Création d'un dictionnaire "Numéro d'accession" : "Genre espèce" à partir des protéomes.
...
ACCESSION_SCRIPT=$1 # Script accession_to_species.py
INPUT_DIR=$2
INPUT_SPECIES="/home/genouest/tp_emp_tps_40958/tp59985/EMP/TP5-8/scripts_exec/05_filtering/c_renaming_species_inFiles/dict_access_species/species_names.txt" # Chemin vers protéomes
...
# Lire les noms d'espèces depuis le fichier
